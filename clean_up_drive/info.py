...
cho_window.iconbitmap(r'ocean.ico')
cho_window.geometry('850x720')
cho_window.config(bg='gray90')
background=ImageTk.PhotoImage(file='infopage.png')
...
var2=StringVar()
che1=Checkbutton(cho_window,text='SDG 9 - Suatainable Cities and Communicaties',variable=var2,font=('Helvetica',9),bg='#9DC4E5')
che1.deselect()
