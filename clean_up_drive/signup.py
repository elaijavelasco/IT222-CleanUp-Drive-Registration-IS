...
signup_window.iconbitmap(r'ocean.ico')
background=ImageTk.PhotoImage(file='signuppage.png')
...
confirmEntry=Entry(signup_window,width=30,font=('Helvetica',10),fg='black',bg='#DCE5EF')
...
menuPhoto=PhotoImage(file=r'menu3.png')
